...
apt-get --no-install-recommends -y install apt-transport-https ca-certificates-java curl libterm-readline-perl-perl locales memcached net-tools nginx default-jdk
