...
apt-get --no-install-recommends -y install apt-transport-https ca-certificates-java curl libimlib2 libterm-readline-perl-perl locales memcached net-tools nginx default-jdk
